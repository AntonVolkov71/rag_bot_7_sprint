...
# Поднимаемся на три уровня вверх из rag_service
...
if env_path.exists():
    ...
    # Альтернативный вариант - загрузка из текущего каталога
...
#     base_dir = Path(__file__).resolve().parents[2]  # ...\7\
    base_dir = Path(os.getenv("PROJECT_ROOT", "/workspace")).resolve()
